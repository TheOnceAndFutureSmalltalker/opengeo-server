                ...
                for (String fid : diff.getAddedOrder()) {
                    ...
                    if (nextFeature == null) {
                        ...
                        try {
                            ...
                            // make sure addedFeature fid is same as nextFeature
                            // because this is the one that gets sent back in xml response
                            ((org.geotools.filter.identity.FeatureIdImpl)
                                            (addedFeature.getIdentifier()))
                                    .setID(nextFeature.getID());
                            writer.write();
